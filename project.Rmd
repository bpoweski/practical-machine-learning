...
The primary code to preprocess the data is located [here](/blob/master/project.R).

There is additional code within the knitr markdown file [here](/blob/master/project.Rmd).
